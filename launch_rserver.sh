...
then
# change the hpc domain to the one you use
	printf "\nYou need to open new terminal and ssh ${USER}@login.hpcc.ttu.edu -L ${RSTUDIO_PORT}:${RSTUDIO_HOST}:${RSTUDIO_PORT}\n" 
	printf "Then open in new browser localhost:$RSTUDIO_PORT\n"
